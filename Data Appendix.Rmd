...
# 7026 people sleep less than 7 hours
count(sleepshort)

sleepmoderate <- data %>% 
  filter(HRSLEEP >= 7 & HRSLEEP <= 9)

# 13,413 people sleep between 7 and 9 hours, inclusive
count(sleepmoderate)

sleeplong <- data %>% 
  filter(HRSLEEP > 9)

# 858 people sleep more than 9 hours
count(sleeplong)

# sleeplong number a concern?
```
