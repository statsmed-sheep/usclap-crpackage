...
model_full <- lm(data = data, formula = years ~ HRSLEEP + depfreq_often + depfreq_monthly + I(HRSLEEP*depfreq_often) + I(HRSLEEP*depfreq_often) + AGE + activity_score + SEX + income_high + income_middle + health_binary + race_asian + race_black + race_na)
