...
## Abstract
  ...
  The purpose of our analysis is to investigate the interaction between sleep and depression frequency by sex as risk factors for diabetes, contributing to the existing research that has established each of these risk factors independently. Using 2018 National Health Interview Survey data from the IPUMS database, we fit four logistic regression models with diabetes status as the response. We found both sleep and daily or weekly depression to be significant predictors of diabetes in both the full and simple models. However, when separating by sex, we found only depression frequency to be significant for women and only sleep to be significant for men. This research adds to the growing evidence of a link between mental and physical health.
